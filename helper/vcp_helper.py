...
from userbot.helpers import _arankutils, fileinfo
    ...
    async def join_vc(self, chat, join_as=None):
        ...
        try:
            await self.app.join_group_call(
                chat_id=chat.id,
                stream=AudioPiped("arankvc/resources/Silence01s.mp3"),
        ...
        **kwargs,
        ...
        if reply:
            ...
            try:
                ...
                url = input
                img = (
                    "https://github.com/CoderXKrishna/ArankVcPlayer/raw/beta/resources/404.png"
                )
            ...
            if path.exists():
                ...
                if kwargs:
                    ...
                    img = "https://github.com/CoderXKrishna/ArankVcPlayer/raw/beta/resources/404.png"
        ...
        if not self.PLAYLIST:
            if self.PLAYING:
                await self.app.change_stream(
                    self.CHAT_ID,
                    AudioPiped("arankvc/resources/Silence01s.mp3"),
                )
            self.PLAYING = False
